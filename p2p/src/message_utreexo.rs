...
pub struct PackedPositions {
    /// The 0th leaf. Always present.
    pub leaf_0: u64,
    /// The 1st leaf. It's presence is optional.
    pub leaf_1: Option<u64>,
    /// The 2nd leaf. It's presence is optional.
    pub leaf_2: Option<u64>,
    /// The 3rd leaf. It's presence is optional.
...
impl Encodable for PackedPositions {
    ...
    fn consensus_encode<W: Write + ?Sized>(&self, w: &mut W) -> Result<usize, io::Error> {
        ...
        // The 0th leaf is always present.
        len += self.leaf_0.consensus_encode(w)?;

        // The 1st, 2nd and 3rd leaves are optional.
